...
- **The metric we planned to compare on was meaningless.** "Oxygen escape efficiency" — gas out over gas generated — is ~100% for *any* converged solution, because that's what conservation of mass means. It can't distinguish a good PTL from a bad one. We switched to local saturation and pressure after realizing that. 
